...
export const copy = {
  es: {
    ...
    guide: {
      ...
      autoSave: "Registro automático activo",
      autoSaveText: "Cada avance, quiz y sesión queda guardado internamente como memoria, nota Markdown y ledger JSON para sincronización posterior con Obsidian/GitHub.",
      reset: "Reiniciar cero",
      logout: "Salir",
      local: "Memoria local activa",
      ledger: "Ledger interno listo",
  ...
  en: {
    ...
    guide: {
      ...
      autoSave: "Automatic log active",
      autoSaveText: "Every step, quiz, and session is stored internally as memory, Markdown note, and JSON ledger for later Obsidian/GitHub sync.",
      reset: "Reset to zero",
      logout: "Sign out",
      local: "Local memory active",
      ledger: "Internal ledger ready",
